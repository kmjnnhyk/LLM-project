 ...
 */
function getHealthConcernLabel(value: string): string {
 ...
 */
function getExerciseLabel(value: string): string {
  const labels: Record<string, string> = {
 ...
 */
function getSleepQualityLabel(value: string): string {
  const labels: Record<string, string> = {
 ...
 */
function getStressLevelLabel(value: string): string {
  const labels: Record<string, string> = {
    [STRESS_LEVEL.low]: '낮음',
 ...
 */
export function buildNutritionPrompt(data: OnboardingData): string {
 ...
 */
export function buildNutritionPromptWithSchema(data: OnboardingData): {
  prompt: string;
  schema: unknown;
} {
  return {
 ...
 */
export function buildNutritionPromptWithExamples(data: OnboardingData): string {
